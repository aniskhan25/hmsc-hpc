...
def test_simulate_spatial_eta_effect_data_is_deterministic_and_named():
    left = simulate_spatial_eta_effect_data(n_sites=25, n_species=4, seed=122)
    right = simulate_spatial_eta_effect_data(n_sites=25, n_species=4, seed=122)
