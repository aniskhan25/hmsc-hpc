...
Anchored probit benchmarks must record the deterministic anchor type and
numerical settings. Legacy and anchored candidates must use identical seeded
training/calibration/SBC corpora, but separate architecture-compatible
checkpoints.
