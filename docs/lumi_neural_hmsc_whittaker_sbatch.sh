#!/bin/bash -l
#SBATCH --job-name=neural-whittaker-requal
...
RUN_NAME="${RUN_NAME:-neural_whittaker_requalification_${SLURM_JOB_ID:-manual}}"
...
PREDICTIVE_MEAN_CALIBRATION="${PREDICTIVE_MEAN_CALIBRATION:-none}"
PREDICTIVE_MEAN_CALIBRATION_VALIDATION_DATASETS="${PREDICTIVE_MEAN_CALIBRATION_VALIDATION_DATASETS:-0}"
...
PREDICTIVE_MEAN_CALIBRATION_MIN_IMPROVEMENT="${PREDICTIVE_MEAN_CALIBRATION_MIN_IMPROVEMENT:-0.0}"
...
PREDICTIVE_MEAN_SELECTION_POLICY="${PREDICTIVE_MEAN_SELECTION_POLICY:-apply_selected}"
...
echo "Predictive mean validation/max ratios/min improvement: ${PREDICTIVE_MEAN_CALIBRATION_VALIDATION_DATASETS}/${PREDICTIVE_MEAN_CALIBRATION_MAX_BRIER_RATIO},${PREDICTIVE_MEAN_CALIBRATION_MAX_LOG_LOSS_RATIO}/${PREDICTIVE_MEAN_CALIBRATION_MIN_IMPROVEMENT}"
...
echo "Whittaker Neural-HMSC requalification complete: ${RUN_ROOT}"
