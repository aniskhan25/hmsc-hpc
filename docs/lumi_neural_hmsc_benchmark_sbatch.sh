...
# The default coefficient calibration is the promoted external-monotone
# competitor. Set COEFFICIENT_CALIBRATION=conditional to run the legacy
# conditional baseline, or COEFFICIENT_CALIBRATION=scalar for the scalar
# coefficient-posterior baseline.
...
echo "Rare calibration/validation datasets: ${RARE_CALIBRATION_DATASETS}/${RARE_VALIDATION_DATASETS}"
...
echo "External monotone datasets/max multiplier/min gains: ${EXTERNAL_MONOTONE_DATASETS}/${EXTERNAL_MONOTONE_MAX_MULTIPLIER}/${EXTERNAL_MONOTONE_MIN_OOD_GAIN},${EXTERNAL_MONOTONE_MIN_COMBINED_GAIN}"
