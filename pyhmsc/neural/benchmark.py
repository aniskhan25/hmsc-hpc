...
def render_sbc_markdown(rows: pd.DataFrame | Sequence[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "- Stratified rows separate prevalence, coefficient identity, and expected design-information quantiles; qualification still uses the `overall` row.",
        "- Expected design information is evaluated at the raw posterior mean, not simulated coefficient truth.",
